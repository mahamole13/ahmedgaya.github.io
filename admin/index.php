        ...
        <div class="card card-bg">
          <div class="card-body">
            ...
            <li class="kural" style="text-shadow: #6495ed 1px 1px 25px; background-image: url(https://media.giphy.com/media/eYRGWfchREFUUlXT7P/giphy.gif);">Sorgu panelimizde <span style="color: yellow; font-weight: 500"><b>MULTİ (ÇİFT HESAP) ÜYELİK KULLANIMI</b></span>
              ...
              <li class="kural">Ünlülere ve Devlet yetkililerine sorgu atılması tavsiye edilmez.
              </li>
            </ul>
          </div>
        </div>
...
<div class="content py-3">
  <div class="row fs-sm">
    <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-end">
      Crafted with <i class="fa fa-heart text-danger"></i> by <a class="fw-semibold" href="Kronik.org" target="_blank">Ahmed Gaya v2.1</a>
    </div>
    <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
      <a class="fw-semibold" href="Kronik.org" target="_blank">Ahmed Gaya v2.1</a> © <span data-toggle="year-copy" class="js-year-copy-enabled">2022 - 2023</span>
    </div>
  </div>
</div>
